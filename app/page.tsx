...
.arc{stroke:#5c8ff0;stroke-width:1.85;stroke-opacity:.74;filter:none}#standalone-tile-overlay .arc{stroke:#165fbd;stroke-width:2;stroke-opacity:.8}.marker{fill:#dc3214;stroke:#fff;stroke-width:2;filter:none}.marker.estimated{fill:#007681;stroke:#fff;stroke-dasharray:2 1}.origin{fill:#007681;stroke:#fff;stroke-width:2.2;filter:none}.cluster-dot{filter:none}.paths-hidden .arc{display:none}.path-toggle{position:absolute;z-index:5;top:16px;left:16px;min-height:34px;padding:0 10px;border:1px solid var(--line);border-radius:5px;background:rgba(9,17,21,.92);color:var(--muted);font-size:11px}.path-toggle.is-on{color:var(--ink);box-shadow:inset 3px 0 #5c8ff0}.path-toggle:hover{background:#18252a}
</style>
</head>
<body>
